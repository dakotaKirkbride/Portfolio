...
import {ReactComponent as CoolPic} from '../../images/undraw_feeling_proud_qne1.svg';

class Main extends Component {
  render() {
    return (
      <div className="mainView" id="main">
        <div className='mainViewItems'>
          <div className='mainViewItemsLeft'>
          ...
          <div className='mainViewItemsRight'>
            <CoolPic/>
          </div>
        </div>
        <div class="custom-shape-divider-bottom-1637659535">
